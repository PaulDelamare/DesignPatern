...
describe('validateData multiple errors', () => {
    ...
    it('should throw both "required" and "min" errors when both fields are invalid', async () => {
        const invalidData: unknown = { age: 16 };

        try {
            await validateData(schema, invalidData as never);
        } catch (error: any) {
    ...
    it('should throw "required" error when "name" is missing', async () => {
        const invalidData: unknown = { age: 20 };  // "name" is missing
    ...
    it('should throw "min" error when "age" is less than 18', async () => {
        const invalidData: unknown = { name: 'John', age: 16 };  // "age" is below the minimum
    ...
    it('should throw "string" error when "name" is not a string', async () => {
        const invalidData: unknown = { name: 123, age: 20 };  // "name" is a number instead of a string
    ...
    it('should throw "number" error when "age" is not a number', async () => {
        const invalidData: unknown = { name: 'John', age: 'twenty' };  // "age" is a string instead of a number
